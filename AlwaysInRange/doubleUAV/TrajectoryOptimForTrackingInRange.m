...
problem.states.x0=[-4 -2 0 0 100 100];

% Initial conditions for system. Bounds if x0 is free s.t. x0l=< x0 <=x0u
problem.states.x0l=[-5 -5 0 0 100 100];
problem.states.x0u=[-3 0 0 0 100 100];

% State bounds. xl=< x <=xu
% problem.states.xl=[-100 -100 -5 -5 50 50]; 
% problem.states.xu=[ 100 100 5 5 100 100];
problem.states.xl=[-50 -50 -5 -5 0 0]; 
problem.states.xu=[ 50 50 5 5 100 100];
