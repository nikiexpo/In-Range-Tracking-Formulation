...
p1=plot(tt, x2, 'LineWidth',2,'Color',[0.4940 0.1840 0.5560]);
...
% p1=plot(tt, x2, 'LineWidth',2,'Color',[0.4940 0.1840 0.5560]);
% p2=plot(tt, x1, 'LineWidth',2,'Color',[0.4660 0.6740 0.1880]);
p1=plot(tt, x2, 'LineWidth',2);
p2=plot(tt, x1, 'LineWidth',2);
p3=plot(tt, problem.data.XT(tt), 'r--');
hold off 
xlim([0 tt(end)])
...
legend([p1,p2,p3,p4],["Tracker 1", "Tracker 2", "Target", "Out-of-range Region"],'NumColumns',2,'Interpreter','latex','FontSize',11)
