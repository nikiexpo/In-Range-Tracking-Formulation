function options = settings_TrajectoryOptimForTrackingInRange(varargin)
...
options.ipopt.max_iter=1600;                   % Maximum number of iterations. The default value is 3000.
