...
tt1 = linspace(0,200,20);
pt1=5.*sin(2.*pi.*tt1./100)+6;

tt2 = linspace(200,300,15);
pt2=15.*sin(2.*pi.*tt2./100)+6;

tt3 = linspace(300,500,20);
pt3=5.*sin(2.*pi.*tt3./100)+6;

tt4 = linspace(500,600,15);
pt4=15.*sin(2.*pi.*tt4./100)+6;

tt5 = linspace(600,1000,40);
pt5=5.*sin(2.*pi.*tt5./100)+6;

% tt6 = linspace(800,900,15);
% pt6=15.*sin(2.*pi.*tt6./100)+6;

% x_t = pchip(tt,pt);
x_t = griddedInterpolant([tt1,tt2(2:end),tt3(2:end),tt4(2:end),tt5(2:end)],[pt1,pt2(2:end),pt3(2:end),pt4(2:end),pt5(2:end)],'pchip','nearest');
problem.data.XT = x_t;
